...
describe("LLM 生产 HTTP 传输层", () => {
  ...
  it("DeepSeek V4 thinking 请求通过真实 HTTP 传输发送 thinking.type=enabled、reasoning_effort=max、max_tokens=512000", async () => {
    ...
    expect(observedBody?.max_tokens).toBe(512_000);
