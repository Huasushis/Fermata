...
正式审题还包含独立的选题口味：每道题、每轮审核从预设偏好中抽取三个人格标签，同轮重试和服务重启不改变标签。审核意见公开展示标签、第一印象、具体取舍理由，并区分技术判断和个人推荐。Fermata 可以不喜欢一道技术正确的题并提交“不通过”意见，但不能编造技术错误，也不能仅因没抽到某个知识点标签而拒绝。喜欢一道题也不能覆盖技术错误或需要修改的结论。此功能表达主观编辑意见，不代表客观准确率；最终题目状态仍遵循 Urmotiv 配置的审核规则。
